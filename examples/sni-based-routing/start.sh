...
echo "3. Test with: docker exec -it kafka-1 kafka-console-producer --bootstrap-server kafka.gateway.local:19092 --topic test --producer.config /etc/kafka/client.properties"
echo ""
...
echo "  Gateway SNI Endpoint: kafka.gateway.local:19092"
